...
(function (global) {
  ...
  var THIS_SRC = (typeof document !== "undefined" && document.currentScript && document.currentScript.src) || "";
  ...
  // Everything below wires into the browser. Under Node (the test harness that
  // requires this file for the queue core) these globals don't exist, so guard
  // the whole bootstrap — in a real browser every check is true and behaviour
  // is unchanged.
